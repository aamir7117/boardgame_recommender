...
if __name__ == '__main__':
    ...
    extracting users & ratings from ratings page 154 of total pages 692
https://boardgamegeek.com/boardgame/13/catan/ratings?rated=1&pageid=154
extracting users & ratings from ratings page 155 of total pages 692
https://boardgamegeek.com/boardgame/13/catan/ratings?rated=1&pageid=155
-------------------------------------------------------------------------
    ...
    # machine_num = 9 #running on  ec2-18-220-54-59.us-east-2.compute.amazonaws.com --started on 2:32pm, 07/11/2017    ip-172-31-12-40   #expected to finish in 1.5 hrs max
    ...
    # machine_num = 15 #running on  ec2-13-59-74-161.us-east-2.compute.amazonaws.com --started on 7:22pm, 07/11/2017    ip-172-31-14-170   #expected to finish in 1.5 hrs max
